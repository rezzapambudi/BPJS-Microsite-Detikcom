<section class="aturan">
				<div class="tabs tabs-style-iconbox" id="tabbpjs">
					<nav>
						<ul>
							<li id="tabsyarat"><a href="#section-iconbox-1" style="color:#ffffff;"><i class="fa fa-list-ol" aria-hidden="true"></i>
                                <br><span>Persyaratan</span></a></li>
							<li id="tabjuri"><a href="#section-iconbox-2" style="color:#ffffff;"><i class="fa fa-cog" aria-hidden="true"></i>
                                <br><span>Sistem Penjurian</span></a></li>
							<li id="tabperiode"><a href="#section-iconbox-3" style="color:#ffffff;"><i class="fa fa-calendar-o" aria-hidden="true"></i>
                                <br><span>Periode</span></a></li>
							<li id="tabtema"><a href="#section-iconbox-4" style="color:#ffffff;"><i class="fa fa-hand-o-down" aria-hidden="true"></i>
                                <br><span>Rekomendasi tema</span></a></li>
							<!--<li id="tabhadiah"><a href="#section-iconbox-5" style="color:#ffffff;"><i class="fa fa-money" aria-hidden="true"></i>
    ...
    <script>
        ...
        $( document ).ready(function() {
                            ...
                            if (identifier === "#tabbpjs") {
                                $("#tabsyarat").removeClass('tab-current');
                                $("#tabjuri").removeClass('tab-current');
                                $("#tabperiode").removeClass('tab-current');
                                $("#tabtema").removeClass('tab-current');
                                $("#tabhadiah").addClass('tab-current');
                                ...
                                //$('.nav-tabs a[href="#section-iconbox-5"]').parents('li').addClass('content-current');
                                //$("#section-iconbox-5").show();
                            }
					...
					<div class="content-wrap">
						...
						<section id="section-iconbox-5"><p>
                            <ol>
                        <li class="litabs"><div>1 pemenang utama dengan hadiah uang tunai Rp 15.000.000,-</div></li>
                        <li class="litabs"><div>1 pemenang most view pengguna platform blogdetik dengan hadiah uang tunai Rp 5.000.000,-</div></li>
                        <li class="litabs"><div>1 pemenang most RT dengan hadiah uang tunai Rp 2.000.000,-</div></li>
                        <li class="litabs"><div>5 pemenang postingan terpilih dengan hadiah uang tunai total Rp 5.000.000,-</div></li>
                        <li class="litabs"><div>Gimmick 15 postingan pertama yang sesuai S&amp;K berhadiah voucher total Rp 3.000.000,-</div></li>
                        </ol>
                            </p></section>-->
					</div><!-- /content -->
				</div><!-- /tabs -->
