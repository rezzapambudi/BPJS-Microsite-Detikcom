      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="overflow-y: scroll;height: 500px;">
          <div class="edit-list">
                        ...
                        <li class="litabs"><div>Posting tulisan sarkasme sesuai tema di blog kamu</div></li>
                        ...
                        <li class="litabs"><div>Peserta wajib share judul dan link tulisan ke Twitter dengan hashtag <a href="https://twitter.com/search?f=tweets&q=%23BahagiaDiHariTua&src=typd" target="_blank">#BahagiaDiHariTua</a> serta mention <a href="https://twitter.com/BPJSTKinfo" target="_blank">@BPJSTKinfo.</a> dan <a href="https://twitter.com/blogdetik" target="_blank">@blogdetik.</a></div></li>
                        <li class="litabs"><div>Kirim URL lengkap postinganmu dengan mengisi form di halaman daftar</div></li>
        ...
        <div class="modal-footer">
          <span><button type="button" class="btn btn-default" data-dismiss="modal" id="daftar2">Daftar</button></span>
